...
export declare function moveOrthogonalSegment(points: readonly OrthogonalPoint[], segmentIndex: number, coordinate: number): OrthogonalPoint[];
export declare function orthogonalPathPoints(start: OrthogonalPoint, end: OrthogonalPoint, obstacles?: BoundingBox[], variant?: OrthogonalVariant, waypoints?: readonly OrthogonalPoint[]): OrthogonalPoint[];
